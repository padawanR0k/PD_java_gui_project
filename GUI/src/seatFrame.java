...
public class seatFrame extends javax.swing.JFrame {
    ...
    public seatFrame(int count) { // 좌석 개수
        ...
        //버튼 배치  
        JButton[][] jb = new JButton[10][8];
        for(int i=0;i<10;i++) {
            for(int j=0;j<8;j++) {
                jb[i][j] = new JButton((char)(65+j)+""+i); // 아스키
                ...
                jb[i][j].addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        int sss = (int)button.getText().charAt(0)-65;
                        int col = (int)(button.getText().charAt(1))-48;
                        if(col>count-1){
                            for(int k=9;k>=count;k--){
                                jb[k][sss].setBackground(new Color(200,125,125));
                                jb[k][sss].setEnabled(false);
                            }
                        }
                        else{
                            for(int k=0;k<count;k++){
                                jb[(col+k)%10][sss].setBackground(new Color(200,125,125));
                            }
                        }
                    }
                    @Override  
                    ...
                    public void mouseExited(MouseEvent e) {
                        ...
                        if(col>count-1){
                            for(int k=9;k>=count;k--){
                                jb[k][sss].setBackground(new Color(170,170,170));
                            }
                        }
                        else{
                            for(int k=0;k<count;k++){
                                jb[(col+k)%10][sss].setBackground(new Color(170,170,170));
                            }
                        }
                    }
                });
